    ...
    <>
      ...
      <Dialog open={open}>
        <DialogContent className="sm:max-w-[850px] max-h-[80vh] overflow-y-auto text-black">
          <DialogHeader>
            <DialogTitle>AI Powered Javascript documentation search</DialogTitle>
            <DialogDescription>
              Try to Ask Basic Questions, since our training data is limited.
            </DialogDescription>
            <hr />
            ...
            <div className="grid gap-4 py-4 text-slate-700">
              ...
              <div className="text-xs text-gray-500 dark:text-gray-100">
                ...
                <button
                  ...
                  transition-colors"
                  onClick={(_) => setQuery('What is JavaScript?')}
                >
                  What is JavaScript?
                </button>
              </div>
